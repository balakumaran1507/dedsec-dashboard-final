            ...
            <>
              ...
              {pinnedAnnouncements.map((announcement) => (
                <button
                  ...
                  className={`w-full p-3 border-b border-neutral-900 text-left transition-colors ${
                    selectedAnnouncement.id === announcement.id ? "bg-neutral-900" : "hover:bg-neutral-900/50"
                  }`}
                >
